setwd("C:/Users/jj470306/Desktop/Students_2.Zajecia_Cykl_zycia_Data_science_workflow/Zadanie_Data_science_workflow")
#1. Import danych i instalacja pakietow ----
...
#4.1 mutate() – tworzenie nowych zmiennych na bazie istniej¹cych ----
...
#4.2 filter() – wybieranie wierszy ----
#4.3 select() – wybieranie kolumn ----
...
#4.5 group_by() – grupowanie ----
#4.6 summarise() - obliczanie wartoœci zagregowanych (np. œrednich, sum) ----
